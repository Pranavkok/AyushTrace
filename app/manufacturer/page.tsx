    ...
    <div className="min-h-screen bg-green-100 flex flex-col">
      ...
      <header className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 bg-green-900 text-white px-4 md:px-6 py-4 shadow-md">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold text-sm sm:text-base">Herb Manufacturer Desk</h2>
            <p className="text-xs sm:text-sm text-green-200">
              Manage Herbs & Generate QR
            </p>
          </div>
        </div>
        ...
        <aside className="w-full lg:w-1/3 bg-white rounded-xl shadow-lg p-4">
          ...
          <ul className="space-y-3 text-sm sm:text-base text-gray-700">
            <li className="flex items-center gap-3">
              ...
              <span>🌿 Tulsi - Batch #A102</span>
            </li>
            <li className="flex items-center gap-3">
              <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg" alt="QR" className="w-12 h-12" />
              <span>🌱 Ashwagandha - Batch #B220</span>
            </li>
            <li className="flex items-center gap-3">
              <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg" alt="QR" className="w-12 h-12" />
              <span>🍃 Neem - Batch #C310</span>
            </li>
            <li className="flex items-center gap-3">
              <img src="https://upload.wikimedia.org/wikipedia/commons/d/d0/QR_code_for_mobile_English_Wikipedia.svg" alt="QR" className="w-12 h-12" />
              <span>🌵 Aloe Vera - Batch #D078</span>
            </li>
          </ul>
          <Link
            href="/manufacturer/qrcodes"
        ...
        <section className="flex-1 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-xl shadow-lg p-4">
            <h3 className="text-lg sm:text-xl font-semibold text-green-900 mb-3">
              ✅ Previously Done Transactions
            </h3>
            <ul className="space-y-2 text-sm sm:text-base text-gray-700">
              <li>🌿 Tulsi - 50kg purchased from Farmer #123</li>
              <li>🌱 Ashwagandha - 30kg purchased from Farmer #456</li>
              <li>🍃 Neem - 40kg purchased from Farmer #789</li>
              <li>🌵 Aloe Vera - 20kg purchased from Farmer #321</li>
            </ul>
          </div>
